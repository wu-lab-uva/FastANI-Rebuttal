...
# - Relative tree length decay with dropping genomes per species
...
# RTL data
out <- data.table(read.csv("RTL.decay.10genomes.csv"))
...
spp <- data.table(read.csv("species.information.genome.csv"))
