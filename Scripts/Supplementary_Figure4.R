# Generate Supplementary Figure4 - Relative tree length decay with dropping genomes per species across time
...
# RTL data
out <- data.table(read.csv("FigS4-RTL.decay.10genomes.year.csv"))
